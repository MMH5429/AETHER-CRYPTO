"""
AETHER-CRYPTO: Web Interface
===============================
Flask web app for encrypting and decrypting files through the browser.
After encryption, the original file is securely deleted from the server.
All processing happens in memory — no temp files left on disk.
"""
...
# File format constants (same as CLI)
MAGIC = b"AETH"
VERSION = b"\x01"
HEADER_SIZE = 65
...
def encrypt():
    ...
    try:
        # Read file entirely into memory — nothing touches disk
        plaintext = file.read()
...
def decrypt():
    ...
    try:
        ...
        # Determine output filename (strip .aeth)
